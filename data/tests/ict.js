...
window.TEST_BANK.ict = {
  ...
  questions: [
  {
    ...
    options: [
      "To shorten longweb addresses",
      "To change thedomain of a website",
      "A software program",
      "To create newwebsites",
      "To encrypt URLs",
    ],
    answer: 0, // To shorten longweb addresses
  },
  {
    text: "Android is best classified as one of the fastest growing of these",
    options: [
      "DOS",
      "mobileoperating systems",
      "networkoperating systems",
      "stand-aloneoperating systems",
      "desktopoperating systems",
    ],
    answer: 1, // mobileoperating systems
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "a program that violates the security of a computer system",
      "a program that speeds up the operation of the computer",
    ],
    answer: 3, // a program that violates the security of a computer system
  },
  {
    ...
    options: [
      ...
      "Integratedcircuit",
      "Magnetictape",
      "Vacuumtubes and magnetic drum",
      "Transistor",
    ],
    answer: 3, // Vacuumtubes and magnetic drum
  },
  {
    text: "We can insert a page number at",
    options: ["Header", "GoogleDrive", "Footer", "Both", "None"],
    answer: 3, // Both
  },
  {
  ...
  },
  {
    ...
    options: [
      "Domain NameService",
      "Dynamic NetworkSystem",
      "Digital NetworkService",
      "USB",
      "Domain NameSystem",
    ],
    answer: 4, // Domain NameSystem
  },
  {
    text: "Short cut key for Copy is",
    options: ["Ctrl+c", "Ctrl+b", "Ctrl+f", "Ctrl+x", "Ctrl+z"],
    answer: 0, // Ctrl+c
  },
  {
    text: "Tag for background’s color of the document in HTML?",
    options: ["BODYBGCOLOR", "SU", "TITLE", "END", "HEAD"],
    answer: 0, // BODYBGCOLOR
  },
  {
    text: "Year of invention of the telephone?",
    options: ["1860", "1837", "1876", "1947", "2001"],
    answer: 2, // 1876
  },
  {
    text: "What does ICT stand for?",
    options: [
      "Integrated CommunicationTechnologies",
      "IntegratedComputer Technologies",
      "InternetCommunication Tools",
      "InternationalComputer Technology",
      "Information andCommunication Technology",
    ],
    answer: 4, // Information andCommunication Technology
  },
  {
    ...
    answer: 4, // MicrosoftExcel
  },
  {
    text: "What is the main difference between RAM and ROM?",
    options: [
      "RAM istemporary, while ROM is permanent",
      "RAM is fasterthan ROM",
      "A software program",
      "RAM is used forinput, while ROM is used for output",
      "RAM is used forstorage, while ROM is used for processing",
    ],
    answer: 0, // RAM istemporary, while ROM is permanent
  },
{
  text: "###### means:",
  options: [
    "Thecell is not enough to see all values",
    "Youhave misspelled something",
    "address",
    "Youhave entered a wrong number",
    "Noany mean",
  ],
  answer: 0, // Thecell is not enough to see all values
},
{
...

{
  ...
  options: [
    ...
    "Protecting acomputer from viruses",
    "Analyzing andimproving IT systems",
    "Writing code",
    "Managinghardware components",
  ],
...

{
  ...
  options: [
    "Onlyhalf the screen is seen",
    "Thermodynamics",
    "Fontsize will change",
    "Selectedtext or graphics are removed",
    "Theapplication stops running",
  ],
...
},
{
  ...
  options: [
    "A program usedfor writing code",
    "A website thatindexes and retrieves other websites",
    "A type ofmalware",
    "To encrypt data",
    "A type of computer",
  ],
...

{
  ...
  options: [
    "<BODYBACKGROUND = \"image.jpg\" TEXT = red>",
    "<BODYBGCOLOR = yellow TEXT = blue >",
    "<BODYBGCOLOR = \"image.jpg\" TEXT = red >",
    "<IMGSRC = \" Task1.html \" ALT = \"TEXT\">",
    "<BODYBACKGROUND = image.pdf TEXT = blue >",
  ],
...

{
  ...
  options: [
    "A type ofprogramming language",
    "A method ofcreating digital ads",
    "Writing code",
    "A way toprotect websites from hacking",
    "A method ofimproving website visibility in search engines",
  ],
...

{
  ...
  options: [
    "scanner, microphone, speaker",
    "processor, RAM, hard drive",
    "keyboard, mouse, printer",
    "monitor, printing device, drawing tablet",
...

{
  ...
  options: [
    "To provideinternet access",
    "To store datapermanently",
    "To store datatemporarily for quick access",
    "To store data",
    "To process data",
  ],
...

{
  ...
  options: [
    "structural drawing",
    "programming language",
    "sequence ofactions to solve the problem",
    "rule for multiplying numbers",
    "system workflow",
  ],
...

{
  ...
  options: [
    "= And(E10>74,\"PASSED\",\"FAILED\")",
    "=SUM(A2:A5)",
    "=IF(E10>74,\"PASSED\",\"FAILED\")",
    "IF(E10>75,\"PASSED\",\"FAILED\")",
    "= Count(E10>75,\"PASSED\",\"FAILED\")",
  ],
...

{
  ...
  options: [
    "To increase internetspeed",
    "JavaScript",
    "To manage fileson the internet",
    "To connectdevices wirelessly over short distances",
    "To encrypt data",
  ],
...

{
  ...
  options: [
    "professor.at.learn@@thenet",
    "professor@learnthenet.com",
    "www.learnthenet.com",
    "professor.at.learnthenet",
    "professor.at.learn@thenet",
  ],
...

{
  ...
  options: [
    "A method ofexchanging goods in person",
    "The act ofprogramming websites",
    "The process ofbuying and selling goods over the internet",
    "A way ofstoring data",
    "A software program",
  ],
...

{
  ...
  options: [
    ...
    "only in the form of drawings",
    "all approaches are used",
  ],
...

{
  ...
  options: [
    "Itis a computer program that allows you to create text document.",
    "Itis a computer program that allows you to create and show slides to support a presentation.",
    "Itis a computer program that allows you to create tables.",
    "Itis a computer program that allows you to create video.",
    "Itis a computer program that allows you to paint picture.",
  ],
...

{
  ...
  options: [
    "Textfile",
    "<AHREF=\"Task1.html\"> TEXT </A>",
    "<BODYBGCOLOR = \"Task1.html \" TEXT = black>",
    "<IMGSRC = \" Task1.html \" ALT = \"TEXT\">",
...

{
  ...
  options: [
    ...
    "to protect information on thenetwork",
    "for editing textsand images",
  ],
...

{
  ...
  options: [
    ...
    "To process data",
    "To displayimages on the screen",
    "A software program",
  ],
...

{
  ...
  options: [
    "Small datasetsused for analysis",
    "Writing code",
    "A collection oflarge and complex datasets",
    "A type ofcomputer virus",
    "A networkprotocol",
  ],
...

{
  text: "EDS stands for …",
  options: [
    "EconomicDigital Signature",
    "ElectronicDigital Signature",
    "ElectronicDemography Situation",
    "ElectronicDigital Sample",
...

{
  ...
  options: [
    "Itis the application of computers to store, study, retrieve, transmit, and manipulate data",
    "Itis the transmission of signs, signals, messages, writings, images and sounds",
    "Itis Computer",
    "Itis an evolving set of technologies",
    "It isprogramming code executed on a computer processor",
  ],
...

{
  ...
  options: [
    "Inthe process of copying, not to change the cell address",
    "Returnsthe lowercase letters",
    "Returnsthe smallest number in a set of values",
    "Returnsthe average (arithmetic mean) of the arguments",
    "Returnsthe biggest number in a set of values",
  ],
  answer: 3, // Returnsthe average (arithmetic mean) of the arguments
},
{
  ...
  options: [
    ...
    "extract images",
    "distribution and reception ofinformation for internet access",
...

{
  ...
  options: [
    ...
    "simple and complex",
    "linear, branched and repetitive",
    "linear only",
    "open and closed",
  ],
...

{
  ...
  options: [
    "by dividing the binary number by 10",
    "by adding numbers",
    "by dividing the decimal number by 2",
    "by multiplying the numbers",
    "by dividing the decimal number by 16",
  ],
...

{
  ...
  options: [
    "communication system between computers",
    "program management system on your computer",
    "tools for editing images",
    "sending a message by email",
    "data storage tools of computers",
  ],
...

{
  ...
  options: [
    ...
    "Windows MediaPlayer, VLC Media Player",
    "Adobe Photoshop, CorelDRAW",
    "VLC Player, QuickTime",
...

{
  ...
  options: [
    "To store filesin a physical location",
    "To protect datafrom viruses",
    "To provideinternet access",
    "To encrypt data",
    "To store andprocess data over the internet",
  ],
...

{
  ...
  options: [
    ...
    "control the operation of printingdevices",
    "creating programs",
    "email verification",
  ],
...

{
  ...
  options: [
    "Insertfunctions, which quickly and easily predefined formulas",
    "Callsa mathematical functions",
    "Inthe process of copying, not to change the cell address",
    "Changethe paragraph interval",
    "Callsonly statistical functions",
  ],
...

{
  ...
  options: [
    "GoogleDrive",
    "Theweb search tool built into Google Docs",
    "Yourcomputer's hard drive",
    "inserta drawing",
    "Allof them",
  ],
  answer: 4, // Allof them
...

{
  ...
  options: [
    "Yes,go to the field orientation and change position to 90° in Alignment tab",
    "No",
    "Yes,if text don't have numbers",
    "Onlyin Word Art program",
    "No,go to the field orientation and change position to 30° in Alignment tab",
  ],
...

{
  ...
  options: [
    "A type ofcomputer virus",
    "The uniqueaddress of a website on the internet",
    "To provide internet access",
    "The physicaladdress of a website",
    "A password foraccessing websites",
  ],
...

{
  text: "What is a blog?",
  options: [
    "A website forstoring and sharing photos",
    "A softwareprogram",
    "A personaljournal or article published on the internet",
    "A type of cloudservice",
    "Writing code",
  ],
...

{
  ...
  options: [
    "To create copies of data in case of loss",
    "To output hard copies of digital documents",
    "To organize files",
    "To encrypt data",
...

{
  ...
  options: [
    "NTML",
    "Using a homecomputer for data storage",
    "Using theinternet for data storage and processing",
    "Storing data onphysical servers",
    "Storing filesin physical locations",
  ],
...

{
  ...
  options: [
    "To protect datafrom viruses",
    "To managehardware devices",
    "A software program",
    "To organize,store, and retrieve data",
    "To run softwareprograms",
  ],
...

{
  ...
  options: [
    "A type ofcomputer virus",
    "A type of cloudservice",
    "A tool foranonymous internet browsing",
    "A software forweb design",
    "Windows 10",
  ],
...

{
  ...
  options: [
    "to send an email",
    "to create web pages",
    "for data processing andanalysis",
    "to make notes",
    "for video editing",
  ],
...

{
  ...
  options: [
    "Improvesinternet speed",
    "To organize files",
    "Enhances computer performance",
    "Protects the system from threats",
    "Damages ordisrupts the normal function of a computer",
  ],
